...
class _DoorsScreenState extends ConsumerState<DoorsScreen> {
  ...
  String _doorStatusLabel(Door d) {
    if (d.replacementRequired) return 'FAIL';
  ...
  String _surveyPdfBaseName(Survey survey) {
    return _sanitizeFileName('FireDoor_${_dateTag(survey.reportDate)}');
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (kIsWeb && widget.workspaceKey == 'fire-door') {
      return FireDoorWebShellScaffold(
        currentRoute:
            '/workspace/fire-door/inspection/projects/${widget.surveyId}/doors',
        title: survey.reportName.trim().isEmpty
            ? 'Doors'
            : 'Doors - ${survey.reportName}',
...
class _DisclaimerSheet extends StatefulWidget {
  final bool isFireStopping = false;
